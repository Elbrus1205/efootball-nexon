...
export const rolePermissions = [
  ...
  { id: "users.delete", label: "Удалять аккаунты пользователей" },
  { id: "users.reset", label: "Сбрасывать пароль и привязки пользователей" },
...
export const adminNavPermissions: Record<string, RolePermissionId[]> = {
  ...
  "/admin/users": ["users.view", "users.ban", "users.delete", "users.reset", "users.changeLowerRoles"],
