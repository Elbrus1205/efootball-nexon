...
export const achievementGroups: AchievementGroupDefinition[] = [
  ...
  },
  {
    ...
    metricLabel: "Победы",
    accent: "gold",
    baseImagePath: "/dostij/IMG_6654.webp",
    levels: [
      { key: "wins_100", title: "Победите в 100 матчах", shortTitle: "100 побед", target: 100, imagePath: "/dostij/IMG_6655.webp" },
      { key: "wins_500", title: "Победите в 500 матчах", shortTitle: "500 побед", target: 500, imagePath: "/dostij/IMG_6656.webp" },
      { key: "wins_1500", title: "Победите в 1500 матчах", shortTitle: "1500 побед", target: 1500, imagePath: "/dostij/IMG_6657.webp" },
      { key: "wins_3000", title: "Победите в 3000 матчах", shortTitle: "3000 побед", target: 3000, imagePath: "/dostij/IMG_6658.webp" },
      { key: "wins_5000", title: "Победите в 5000 матчах", shortTitle: "5000 побед", target: 5000, imagePath: "/dostij/IMG_6659.webp" },
    ],
  },
  {
    key: "goals",
    ...
    metricLabel: "Голы",
    accent: "green",
    baseImagePath: "/dostij/IMG_6660.webp",
    levels: [
      { key: "goals_100", title: "Забейте 100 голов", shortTitle: "100 голов", target: 100, imagePath: "/dostij/IMG_6661.webp" },
      { key: "goals_500", title: "Забейте 500 голов", shortTitle: "500 голов", target: 500, imagePath: "/dostij/IMG_6662.webp" },
      { key: "goals_2500", title: "Забейте 2500 голов", shortTitle: "2500 голов", target: 2500, imagePath: "/dostij/IMG_6663.webp" },
      { key: "goals_5000", title: "Забейте 5000 голов", shortTitle: "5000 голов", target: 5000, imagePath: "/dostij/IMG_6664.webp" },
      { key: "goals_10000", title: "Забейте 10000 голов", shortTitle: "10000 голов", target: 10000, imagePath: "/dostij/IMG_6665.webp" },
    ],
  },
  {
    key: "played",
    ...
    metricLabel: "Матчи",
    accent: "blue",
    baseImagePath: "/dostij/IMG_6680.webp",
    levels: [
      { key: "played_100", title: "Сыграйте 100 матчей", shortTitle: "100 матчей", target: 100, imagePath: "/dostij/IMG_6681.webp" },
      { key: "played_1000", title: "Сыграйте 1000 матчей", shortTitle: "1000 матчей", target: 1000, imagePath: "/dostij/IMG_6682.webp" },
      { key: "played_5000", title: "Сыграйте 5000 матчей", shortTitle: "5000 матчей", target: 5000, imagePath: "/dostij/IMG_6683.webp" },
      { key: "played_10000", title: "Сыграйте 10000 матчей", shortTitle: "10000 матчей", target: 10000, imagePath: "/dostij/IMG_6684.webp" },
      { key: "played_15000", title: "Сыграйте 15000 матчей", shortTitle: "15000 матчей", target: 15000, imagePath: "/dostij/IMG_6685.webp" },
    ],
  },
  {
    key: "clean_sheets",
    ...
    accent: "violet",
    baseImagePath: "/dostij/IMG_6686.webp",
    levels: [
      { key: "clean_sheets_10", title: "Проведите 10 сухих матчей", shortTitle: "10 сухих", target: 10, imagePath: "/dostij/IMG_6687.webp" },
      { key: "clean_sheets_100", title: "Проведите 100 сухих матчей", shortTitle: "100 сухих", target: 100, imagePath: "/dostij/IMG_6688.webp" },
      { key: "clean_sheets_500", title: "Проведите 500 сухих матчей", shortTitle: "500 сухих", target: 500, imagePath: "/dostij/IMG_6689.webp" },
      { key: "clean_sheets_1000", title: "Проведите 1000 сухих матчей", shortTitle: "1000 сухих", target: 1000, imagePath: "/dostij/IMG_6690.webp" },
      { key: "clean_sheets_3000", title: "Проведите 3000 сухих матчей", shortTitle: "3000 сухих", target: 3000, imagePath: "/dostij/IMG_6691.webp" },
    ],
  },
];
