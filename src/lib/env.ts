...
const envSchema = z.object({
  ...
  TELEGRAM_MINI_APP_AUTH_MAX_AGE_SECONDS: z.string().optional(),
  TELEGRAM_BOT_USERNAME: z.string().optional(),
  WILLOW_API_BASE_URL: z.string().url().optional(),
  WILLOW_API_TOKEN: z.string().optional(),
  WILLOW_API_MODEL: z.string().optional(),
...
export const env = envSchema.parse({
  ...
  TELEGRAM_MINI_APP_AUTH_MAX_AGE_SECONDS: process.env.TELEGRAM_MINI_APP_AUTH_MAX_AGE_SECONDS,
  TELEGRAM_BOT_USERNAME: process.env.TELEGRAM_BOT_USERNAME,
  WILLOW_API_BASE_URL: process.env.WILLOW_API_BASE_URL,
  WILLOW_API_TOKEN: process.env.WILLOW_API_TOKEN,
  WILLOW_API_MODEL: process.env.WILLOW_API_MODEL,
