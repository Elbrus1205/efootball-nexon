...
export function DeleteUserAccountForm({
  ...
  return (
    <form action={`/api/admin/users/${userId}/delete`} method="post" className="min-w-0 space-y-3 rounded-2xl border border-primary/20 bg-[linear-gradient(180deg,rgba(33,241,168,0.1),rgba(0,0,0,0.2))] p-4">
