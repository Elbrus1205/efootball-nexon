...
export async function Navbar() {
  ...
  return (
    <header className="mobile-premium-header sticky top-0 z-40 overflow-visible border-b border-[#8fe8ff]/15 bg-[#06101f]/95 backdrop-blur-xl">
      <div className="pointer-events-none absolute inset-x-4 bottom-0 h-px bg-gradient-to-r from-transparent via-[#176bff]/70 to-transparent" />
      <div className="relative mx-auto flex h-16 max-w-7xl items-center justify-between gap-2 px-3 sm:h-[72px] sm:gap-3 sm:px-6 lg:h-20 lg:px-8">
        <div className="min-w-0 flex flex-1 items-center gap-2 sm:gap-3 lg:flex-none">
          ...
          <Link href="/" aria-label="eFootball Nexon" className="brand-link group min-w-0 items-center rounded-lg px-1.5 py-1 outline-none transition duration-200 hover:opacity-90 focus-visible:ring-2 focus-visible:ring-[#8fe8ff] lg:flex-none lg:pr-2">
            <div className="min-w-0 max-w-[142px] min-[390px]:max-w-[168px] sm:max-w-none">
              ...
              <div className="mt-1 hidden items-center gap-1.5 text-[10px] font-bold uppercase leading-tight tracking-[0.22em] text-[#a7b7cc] lg:flex">
                <span className="h-1.5 w-1.5 rounded-full bg-[#b8f34a] shadow-[0_0_12px_rgba(184,243,74,0.45)]" />
                Mobile Tournaments
              </div>
            </div>
          </Link>
